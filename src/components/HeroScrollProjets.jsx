      ...
      <motion.div style={{ y: isMobile ? 0 : y, opacity: isMobile ? 1 : opacity }} className="relative z-10 text-white text-center px-8 max-w-6xl mx-auto">
        ...
        >
          <span className="inline-block px-6 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm font-semibold tracking-wider uppercase">
            Réalisations Premium • Créations Uniques
          </span>
        </motion.div>
        ...
        >
          Chaque projet est une œuvre unique<br />
          Architecture tropicale et confort moderne
        </motion.p>
        ...
        >
          <a href="#realisations" className="px-8 py-4 bg-white text-darkblue-500 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all transform hover:scale-105">
...
export default HeroScrollProjets;