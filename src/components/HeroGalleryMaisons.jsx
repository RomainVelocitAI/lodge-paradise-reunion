...
const HeroGalleryMaisons = () => {
  ...
  const title = "Maisons d'Habitation 3 Façades";
  const subtitle = "Le parfait équilibre entre confort moderne et optimisation de l'espace";

  const images = [
    { src: '/images/maisons/maison-3facades-1.jpg', alt: 'Maison 3 Façades moderne' },
    { src: '/images/maisons/maison-3facades-2.jpg', alt: 'Maison T2 Compact' },
    { src: '/images/maisons/maison-3facades-3.jpg', alt: 'Maison T3 Familial' },
    { src: '/images/maisons/maison-3facades-4.jpg', alt: 'Maison T4+ Spacieux' },
    { src: '/images/maisons/maison-3facades-5.jpg', alt: 'Maison 3 façades avec jardin' }
  ];
...
export default HeroGalleryMaisons;