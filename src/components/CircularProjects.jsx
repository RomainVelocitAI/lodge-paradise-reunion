            ...
            <motion.div
              ...
              >
                <Link 
                  ...
                  className="inline-block bg-gradient-to-r from-gold-500 to-gold-600 text-white px-4 py-2 md:px-8 md:py-3 rounded-full text-sm md:text-base font-semibold hover:from-gold-600 hover:to-gold-700 transition-all transform hover:scale-105 shadow-lg"
