  ...
  return (
    ...
    >
      ...
      <motion.div style={{ y: isMobile ? 0 : y, opacity: isMobile ? 1 : opacity }} className="relative z-10 text-white text-center px-8 max-w-6xl mx-auto">
        ...
        >
          Optimisez votre patrimoine avec nos solutions<br />
        ...
        >
          <a href="#investissement" className="px-8 py-4 bg-white text-darkblue-500 rounded-lg font-semibold text-lg hover:bg-gray-100 transition-all transform hover:scale-105">
...
const HeroScrollInvestissement = () => {
  const [isMobile, setIsMobile] = useState(false);
...
export default HeroScrollInvestissement;