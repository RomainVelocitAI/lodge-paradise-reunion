...
const HeroGalleryInvestissement = () => {
  ...
  const images = [
    { src: '/investissement-roi.jpg', alt: 'ROI et rentabilité investissement immobilier' },
    { src: '/defiscalisation-documents.jpg', alt: 'Documents défiscalisation La Réunion' },
    { src: '/portfolio-aerien.jpg', alt: 'Portfolio immobilier vue aérienne' },
    { src: '/reunion-investisseurs.jpg', alt: 'Réunion investisseurs immobiliers' },
    { src: '/lodge-ecologique-solaire.jpg', alt: 'Lodge écologique avec panneaux solaires' }
  ];
...
export default HeroGalleryInvestissement;